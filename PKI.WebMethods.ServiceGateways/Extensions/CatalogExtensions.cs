...
namespace PKI.eBusiness.WMService.ServiceGateways.Extensions
{
    public static class CatalogExtensions
    {
        ...
        public static Entities.StoreFront.DataObjects.InventoryResponse ToInventoryResponse(this InventoryWebServiceResponse1 response)
        {
            var result = new Entities.StoreFront.DataObjects.InventoryResponse();
            if (response.InventoryResponse == null)
            {
                return result;
            }
            result = new Entities.StoreFront.DataObjects.InventoryResponse
            {
