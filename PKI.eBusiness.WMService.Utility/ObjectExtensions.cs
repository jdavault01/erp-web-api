...
using StoreFrontStubs = PKI.eBusiness.WMService.Entities.Stubs.StoreFront;
   ...
   public static class ObjectExtensions
    {
       ...
       public static OrderLookUpResponse ToOrderLookUpResponse(this StoreFrontStubs.OrderInfoWebServiceResponse response)
       {
           OrderLookUpResponse lookUpResponse = new OrderLookUpResponse();
           XDocument xDoc = XDocument.Parse(response.xmlResponse);
           ...
           xDoc = XDocument.Parse(response.xmlResponse);
              ...
              XElement detailResponseHeader = xDoc.XPathSelectElement("//OrderDetailResponseHeader");
               if (detailResponseHeader != null)
               {
                   ...
                   detailResponse.ProductList = detailResponseHeader.GeProducts();
