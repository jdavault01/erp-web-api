...
namespace PKI.eBusiness.WMSHttpApi.UIHelpers
{
    ...
    public sealed class InfoMessage
    {
        ...
        public const string ERROR_MSG_UNABLE_TO_GET_PRICE_RESPONSE = "Unable to get Price for this request.";
        ...
        public const string ERROR_MSG_UNABLE_TO_GET_INVENTORY_RESPONSE = "Unable to get Inventory for this request.";
        ...
        public const string ERROR_MSG_UNABLE_TO_GET_PARTNER_RESPONSE = "Unable to get Partrner for this request.";
        ...
        public const string ERROR_MSG_UNABLE_TO_GET_CREATE_ORDER_RESPONSE = "Unable to get Order Create for this request.";
