...
{
    /// <summary>
    /// ShipToFlagWithAttributes
    /// </summary>
    [DataContract]
    public partial class ShipToFlagWithAttributes :  IEquatable<ShipToFlagWithAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipToFlagWithAttributes" /> class.
        /// </summary>
        ...
        public ShipToFlagWithAttributes(string AccountNumber = default(string), bool? AdditionalEmailNotification = default(bool?), bool? BillAttention = default(bool?), string BillAttentionPreText = default(string), bool? InternalDeliveryInstr = default(bool?), bool? ShipAttention = default(bool?), string ShipAttentionPreText = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipToFlagWithAttributes {\n");
        ...
        {
            return this.Equals(input as ShipToFlagWithAttributes);
        }

        /// <summary>
        /// Returns true if ShipToFlagWithAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipToFlagWithAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipToFlagWithAttributes input)
        {
            if (input == null)
                return false;
