...
{
    /// <summary>
    /// AdditionalEmailNotificationDto
    /// </summary>
    [DataContract]
    public partial class AdditionalEmailNotificationDto :  IEquatable<AdditionalEmailNotificationDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalEmailNotificationDto" /> class.
        /// </summary>
        ...
        public AdditionalEmailNotificationDto(string AccountNumber = default(string), string EmailAddress = default(string), string Id = default(string), bool? OrderConfirmation = default(bool?), bool? ShippingNotification = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdditionalEmailNotificationDto {\n");
        ...
        {
            return this.Equals(input as AdditionalEmailNotificationDto);
        }

        /// <summary>
        /// Returns true if AdditionalEmailNotificationDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalEmailNotificationDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalEmailNotificationDto input)
        {
            if (input == null)
                return false;
