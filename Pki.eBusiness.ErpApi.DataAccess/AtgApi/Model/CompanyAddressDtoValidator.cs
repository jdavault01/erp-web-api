...
{
    /// <summary>
    /// CompanyAddressDtoValidator
    /// </summary>
    [DataContract]
    public partial class CompanyAddressDtoValidator :  IEquatable<CompanyAddressDtoValidator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyAddressDtoValidator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompanyAddressDtoValidator() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyAddressDtoValidator" /> class.
        /// </summary>
        ...
        public CompanyAddressDtoValidator(string CompanyName = default(string), string Address1 = default(string), string City = default(string), string PostalCode = default(string), string Telephone = default(string), string State = default(string), string Address2 = default(string), string Attention = default(string), string Country = default(string), string Fax = default(string), string FirstName = default(string), string Id = default(string), string LastName = default(string), string PartnerId = default(string), string PartnerType = default(string), bool? Rad = default(bool?), string ServicePartType = default(string))
        {
            // to ensure "CompanyName" is required (not null)
            if (CompanyName == null)
            {
                throw new InvalidDataException("CompanyName is a required property for CompanyAddressDtoValidator and cannot be null");
            }
            else
            {
            ...
            if (Address1 == null)
            {
                throw new InvalidDataException("Address1 is a required property for CompanyAddressDtoValidator and cannot be null");
            }
            else
            {
            ...
            if (City == null)
            {
                throw new InvalidDataException("City is a required property for CompanyAddressDtoValidator and cannot be null");
            }
            else
            {
                this.City = City;
            ...
            if (PostalCode == null)
            {
                throw new InvalidDataException("PostalCode is a required property for CompanyAddressDtoValidator and cannot be null");
            }
            else
            {
            ...
            if (Telephone == null)
            {
                throw new InvalidDataException("Telephone is a required property for CompanyAddressDtoValidator and cannot be null");
            }
            else
            {
            ...
            if (State == null)
            {
                throw new InvalidDataException("State is a required property for CompanyAddressDtoValidator and cannot be null");
            }
            else
            {
                this.State = State;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompanyAddressDtoValidator {\n");
        ...
        {
            return this.Equals(input as CompanyAddressDtoValidator);
        }

        /// <summary>
        /// Returns true if CompanyAddressDtoValidator instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyAddressDtoValidator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyAddressDtoValidator input)
        {
            if (input == null)
                return false;
