...
{
    /// <summary>
    /// BillToAddressDtoValidator
    /// </summary>
    [DataContract]
    public partial class BillToAddressDtoValidator :  IEquatable<BillToAddressDtoValidator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToAddressDtoValidator" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BillToAddressDtoValidator() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToAddressDtoValidator" /> class.
        /// </summary>
        /// <param name="PartnerId">PartnerId (required).</param>
        ...
        public BillToAddressDtoValidator(string PartnerId = default(string), string Address1 = default(string), string Address2 = default(string), string Attention = default(string), string City = default(string), string CompanyName = default(string), string Country = default(string), string Fax = default(string), string FirstName = default(string), string Id = default(string), string LastName = default(string), string PartnerType = default(string), string PostalCode = default(string), bool? Rad = default(bool?), string ServicePartType = default(string), string State = default(string), string Telephone = default(string))
        {
            // to ensure "PartnerId" is required (not null)
            if (PartnerId == null)
            {
                throw new InvalidDataException("PartnerId is a required property for BillToAddressDtoValidator and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BillToAddressDtoValidator {\n");
        ...
        {
            return this.Equals(input as BillToAddressDtoValidator);
        }

        /// <summary>
        /// Returns true if BillToAddressDtoValidator instances are equal
        /// </summary>
        /// <param name="input">Instance of BillToAddressDtoValidator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillToAddressDtoValidator input)
        {
            if (input == null)
                return false;
