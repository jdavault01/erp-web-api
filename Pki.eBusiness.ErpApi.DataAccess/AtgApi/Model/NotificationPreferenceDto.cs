...
namespace Pki.eBusiness.ErpApi.DataAccess.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotificationPreferenceDto :  IEquatable<NotificationPreferenceDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationPreferenceDto" /> class.
        /// </summary>
        /// <param name="AdditionalEmailNotifications">AdditionalEmailNotifications.</param>
        public NotificationPreferenceDto(List<AdditionalEmailNotificationDto> AdditionalEmailNotifications = default(List<AdditionalEmailNotificationDto>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotificationPreferenceDto {\n");
        ...
        {
            return this.Equals(input as NotificationPreferenceDto);
        }

        /// <summary>
        /// Returns true if NotificationPreferenceDto instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationPreferenceDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationPreferenceDto input)
        {
            if (input == null)
                return false;
